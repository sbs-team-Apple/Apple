...
<%
	...
	/*
		//*** 위변조 방지체크를 signature 생성 ***
			...
			ex) oid=WelpayTest_1432813606995&price=819000&timestamp=2012-02-01 09:19:04.004
			 * key기준 알파벳 정렬
	...
	*/
	...
	/* 기타 */
	String siteDomain = "http://localhost:8090/pay"; //가맹점 도메인 입력

	// 페이지 URL에서 고정된 부분을 적는다. 
	// Ex) returnURL이 http://localhost:8080/WelpayStdSample/WelStdPayReturn.jsp 라면
	// http://localhost:8080/WelpayStdSample 까지만 기입한다.
...
<head>
    ...
    <!--
    연동시 유의 사항!!
    1) 테스트 URL(tstdpay.paywelcome.co.kr) - 샘플에 제공된 테스트 MID 전용으로 실제 가맹점 MID 사용 시 에러가 발생 할 수 있습니다.
    2) 상용 URL(stdpay.paywelcome.co.kr) - 실제 가맹점 MID 로 테스트 및 오픈 시 해당 URL 변경하여 사용합니다.
    3) 가맹점에서 사용하는 케릭터셋이 EUC-KR 일 경우 charset="UTF-8"로 설정합니다.
    -->
		...
		<tr>
			<td bgcolor="6095BC" align="center" style="padding:10px">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="padding:20px">
					...
					<tr>
						<td>
							이 페이지는 웰컴페이먼츠 웹표준 결제요청을 위한 예시입니다.<br/>
							<br/>
									...
									<td style="text-align:left;">
										<form id="SendPayForm_id" name="" method="POST" >
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/><b>buyeremail</b> :
												<br/><input  style="width:100%;" name="buyeremail" value="test@test.com" >
												...
												<br/><b>returnUrl</b> :
												<br/><input  style="width:100%;" name="returnUrl" value="<%=siteDomain%>/WelStdPayReturn.jsp" >
												<!--
					                            payViewType이 popup일 경우 crossDomain이슈 발생할 수 있음
												-->
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/>사용 가능한 입력 값
												<br/>Card,ACard,VCard,EasyPay,HPP,DirectBank,VBank,CGFT
												<br/><input  style="width:100%;" name="gopaymethod" value="" >
												<br/><br/>

												<br/>
												<b>offerPeriod</b> : 제공기간
												<br/>ex)20210101-20211231, [Y2:년단위결제, M2:월단위결제, yyyyMMdd-yyyyMMdd : 시작일-종료일]
												<br/><input  style="width:100%;" name="offerPeriod" value="" >
												<br/><br/>
											...
											<div style="border:2px #cccccc solid;padding:10px;background-color:#f3f3f3;">
												...
												<!-- 상점부담 무이자할부 옵션 *상점부담무이자 계약필요 -->
												<br/><b>nointerest</b> : 가맹점 분담 무이자 할부 개월
												...
												<br/><b>d_card</b> : 직접호출 카드 코드
												<br/>ex) 01
												<br/><input  style="width:100%;" name="d_card" value="" >
												
												<br/><b>d_quota</b> : 직접호출 할부 선택
												<br/>ex) 02
												<br/><input  style="width:100%;" name="d_quota" value="" >	
											...
											<b>***** 추가 옵션 *****</b>
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												<br/><b>merchantData</b> : 가맹점 임의 데이터(2000byte)
												<br/>인증 결과 수신 구간에서 전달 **한글입력 시 urlencoding 필요**
												<br/><input  style="width:100%;" name="merchantData" value="<%=merchantData%>" >
											</div>
